...
UPDATE SALES SET MONTHNAME_ ='01.OCAK' WHERE DATEPART(MONTH,DATE2) = 1  ---- DATEPART ( MONTH, DATE2 ) ==> AY NUMARASINI GERÝYE DÖNDÜRÜR
...
ORDER BY MONTHNAME_, TOTALPRICE DESC
